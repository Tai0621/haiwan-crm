...
export default function Nav() {
  ...
  // Restore the saved preference once on mount (avoids SSR/client mismatch).
  useEffect(() => {
  ...
  return (
    <aside
      className={`sticky top-0 z-20 flex h-screen shrink-0 flex-col border-r border-slate-200 bg-white transition-[width] duration-200 ${
        collapsed ? "w-16" : "w-56"
      }`}
    >
      <Link
